...
class GlasswareDataTable extends StatefulWidget {
  ...
  const GlasswareDataTable({super.key, required this.department});
...
class _GlasswareDataTableState extends State<GlasswareDataTable> {
  ...
  void submitData() async {
    ...
    var result = await APIService().putGlasswareDetails(
        nameController.text,
  ...
  void getData() async {
    var data = await APIService().getDetails(widget.department, "glassware");
