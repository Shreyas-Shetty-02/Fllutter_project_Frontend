...
class _BotanyState extends State<Botany> {
  ...
  Widget _buildSelectedDataTable() {
    switch (selectedTableIndex) {
      case 0:
        return const ChemicalDataTable(department: "Botany");
      case 1:
        return const InstrumentDataTable(department: "Botany");
      case 2:
        return const GlasswareDataTable(department: "Botany");
      case 3:
        return const SoftwareDataTable(department: "Botany");
      case 4:
        return const TeachingAidsDataTable(department: "Botany");
      default:
        return const ChemicalDataTable(department: "Botany");
    }
  }
