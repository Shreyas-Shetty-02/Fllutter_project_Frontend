...
class _MathematicsState extends State<Mathematics> {
  ...
  Widget _buildSelectedDataTable() {
    switch (selectedTableIndex) {
      case 0:
        return const ChemicalDataTable(department: "Mathematics");
      case 1:
        return const InstrumentDataTable(department: "Mathematics");
      case 2:
        return const GlasswareDataTable(department: "Mathematics");
      case 3:
        return const SoftwareDataTable(department: "Mathematics");
      case 4:
        return const TeachingAidsDataTable(department: "Mathematics");
      default:
        return const ChemicalDataTable(department: "Mathematics");
    }
  }
