...
class _CSState extends State<CS> {
  ...
  Widget _buildSelectedDataTable() {
    switch (selectedTableIndex) {
      case 0:
        return const ChemicalDataTable(department: "Computer_Science");
      case 1:
        return const InstrumentDataTable(department: "Computer_Science");
      case 2:
        return const GlasswareDataTable(department: "Computer_Science");
      case 3:
        return const SoftwareDataTable(department: "Computer_Science");
      case 4:
        return const TeachingAidsDataTable(department: "Computer_Science");
      default:
        return const ChemicalDataTable(department: "Computer_Science");
    }
  }
