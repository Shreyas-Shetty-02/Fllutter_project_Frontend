...
class _PhysicsState extends State<Physics> {
  ...
  Widget _buildSelectedDataTable() {
    switch (selectedTableIndex) {
      case 0:
        return const ChemicalDataTable(department: "Physics");
      case 1:
        return const InstrumentDataTable(department: "Physics");
      case 2:
        return const GlasswareDataTable(department: "Physics");
      case 3:
        return const SoftwareDataTable(department: "Physics");
      case 4:
        return const TeachingAidsDataTable(department: "Physics");
      default:
        return const ChemicalDataTable(department: "physics");
    }
  }
