...
class _ZoologyState extends State<Zoology> {
  ...
  Widget _buildSelectedDataTable() {
    switch (selectedTableIndex) {
      case 0:
        return const ChemicalDataTable(department: "Zoology");
      case 1:
        return const InstrumentDataTable(department: "Zoology");
      case 2:
        return const GlasswareDataTable(department: "Zoology");
      case 3:
        return const SoftwareDataTable(department: "Zoology");
      case 4:
        return const TeachingAidsDataTable(department: "Zoology");
      default:
        return const ChemicalDataTable(department: "Zoology");
    }
  }
